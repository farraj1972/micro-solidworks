...
public:
    ...
    [[nodiscard]] VisualEntityId add(const Polyline3& polyline);
    [[nodiscard]] VisualEntityId add(const SegmentSet3& segments);
    ...
    bool setGeometry(VisualEntityId id, PresentedGeometry geometry);
    bool remove(VisualEntityId id) noexcept;
private:
