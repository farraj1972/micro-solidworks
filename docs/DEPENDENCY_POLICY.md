...
- Topological model: `BUILD`, frozen in D6 as a project-owned
  ...
  oriented uses are specified by accepted ADR-0025–0027. D6 implements no
  target or topology; B7 is the next active campaign.
