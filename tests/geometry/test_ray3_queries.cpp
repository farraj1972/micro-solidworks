...
TEST(Ray3Queries, ContainsToleranceAndDomain) {
 const auto a=Ray3{Point3{},Vector3{1,0,0}};
...
TEST(Ray3Queries, SymmetricRelationsAndTolerance) {
 const auto a=Ray3{Point3{},Vector3{1,0,0}}, opposite=Ray3{Point3{},Vector3{-1,0,0}}, ortho=Ray3{Point3{},Vector3{0,1,0}};
 ...
 const auto nearP=Ray3{Point3{},Vector3{1,5e-10,0}}, farP=Ray3{Point3{},Vector3{1,2e-9,0}};
 const auto nearO=Ray3{Point3{},Vector3{5e-10,1,0}}, farO=Ray3{Point3{},Vector3{2e-9,1,0}};
...
TEST(Ray3Queries, ExtremeOffsetPreservesSmallResidual) {
 const auto m=std::numeric_limits<Scalar>::max(), tiny=std::numeric_limits<Scalar>::denorm_min();
 const Ray3 a{Point3{-m,0,0},Vector3{1,0,0}};
...
TEST(Ray3Queries, PointAtValuesAndValidation) {
 const auto a=Ray3{Point3{},Vector3{1,0,0}};
 ...
 const auto diagonal=Ray3{Point3{},Vector3{3,4,2}};
 EXPECT_TRUE(diagonal.contains(diagonal.pointAt(0.37)));
}
TEST(Ray3Queries, ExtremePointAt) {
