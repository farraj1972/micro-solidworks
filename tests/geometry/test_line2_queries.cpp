...
TEST(Line2Queries, ContainsToleranceAndDomain) {
 const auto a=Line2{Point2{},Vector2{1,0}};
 ...
 EXPECT_TRUE(a.contains(Point2{-1,0}));
 EXPECT_TRUE(a.contains(Point2{10,0}));
 EXPECT_TRUE(a.contains(Point2{-5e-10,0}));
 EXPECT_TRUE(a.contains(Point2{-5e-10,0},0));
...
TEST(Line2Queries, SymmetricRelationsAndTolerance) {
 const auto a=Line2{Point2{},Vector2{1,0}}, opposite=Line2{Point2{},Vector2{-1,0}}, ortho=Line2{Point2{},Vector2{0,1}};
 ...
 const auto nearP=Line2{Point2{},Vector2{1,5e-10}}, farP=Line2{Point2{},Vector2{1,2e-9}};
 const auto nearO=Line2{Point2{},Vector2{5e-10,1}}, farO=Line2{Point2{},Vector2{2e-9,1}};
...
TEST(Line2Queries, ExtremeOffsetPreservesSmallResidual) {
 const auto m=std::numeric_limits<Scalar>::max(), tiny=std::numeric_limits<Scalar>::denorm_min();
 const Line2 a{Point2{-m,0},Vector2{1,0}};
...
TEST(Line2Queries, PointAtValuesAndValidation) {
 const auto a=Line2{Point2{},Vector2{1,0}};
 ...
 EXPECT_TRUE(areCoincident(a.pointAt(-2),Point2{-2,0},0));
 ...
 const auto diagonal=Line2{Point2{},Vector2{3,4}};
 EXPECT_TRUE(diagonal.contains(diagonal.pointAt(0.37)));
}
TEST(Line2Queries, ExtremePointAt) {
